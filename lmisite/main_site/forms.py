...
class ConfigForm(forms.ModelForm):
    ...
    class Meta:
        fields = sorted((
            ...
            'home_testimonials_cta', 'home_testimonials_cta_link',
            'about_title', 'about_header_image', 'about_headshot_image', 'about_image_2', 'about_description',
            'about_mission_statement', 'about_text', 'about_text_2', 'about_top_cta', 'about_top_cta_link',
            'about_cta', 'about_cta_link', 'about_testimonials_cta', 'about_testimonials_cta_link',
            ...
            'services_cta_link', 'services_testimonials_cta', 'services_testimonials_cta_link',
